...
* code.text = "iHRIS Relationship"
* extension[reportdetails].extension[name].valueString = "hivcbspatient"
* extension[reportdetails].extension[label].valueString = "HIV CBS Patient list"
* extension[reportdetails].extension[resource].valueString = "Patient"
* extension[reportdetails].extension[reportelement][0].extension[label].valueString = "fullname"
* extension[reportdetails].extension[reportelement][0].extension[name].valueString = "name.given + ' ' + name.family"
* extension[reportdetails].extension[reportelement][0].extension[display].valueString = "Fullname"
