Feature: 3A
      Scenario: MRN00003A-46-175-062009
      ...
      Scenario: MRN00003A-47-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-48-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Hiwot                  |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-49-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Mourine                |
                  ...
                  | deathCause                           |                        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-50-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Galgsllo               |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-51-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Sichael                |
            ...
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-52-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Bethel                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-53-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | John                   |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-54-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Kidane                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-55-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Yosef                  |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-56-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Nunu                   |
                  ...
                  | enrolledToCareUID                    | 2022-3A-00011175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-58-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Kidane                 |
                  ...
                  | enrolledToCareUID                    | 2022-3A-00012175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-60-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Yosef                  |
                  ...
                  | enrolledToCareUID                    | 2022-3A-00013175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-62-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Atikem                 |
                  ...
                  | enrolledToCareUID                    | 2022-3A-00014175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-64-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Asres                  |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | enrolledToCareUID                    | 2022-3A-00015175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-66-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Almaz                  |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | enrolledToCareUID                    | 2022-3A-00016175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-68-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Almaz                  |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | enrolledToCareUID                    | 2022-3A-00017175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-70-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Aminat                 |
            ...
            Given I set FHIR bundle parameters
                  ...
                  | enrolledToCareUID                    | 2022-3A-00018175062009 |
                  | enrolledToCareFacCode                | HIVOrganizationExample |
                  | enrolledToCareFacName                | Reporting Facility 3A  |
                  | enrolledToCareDateFirstClinicalVisit | 2022-05-01             |
                  | artInitiationDate                    | 2022-05-01             |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-72-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Amsale                 |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-73-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Ansha                  |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-74-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Abebe                  |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-75-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Berhanu                |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-76-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Mohammed               |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-77-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Dadi                   |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-78-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Yimer                  |
                  ...
                  | deathCause                           | HIV Related            |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-79-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Bisrat                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-80-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Dereje                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-81-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Elias                  |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-82-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Tadesse                |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-83-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Behailu                |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-84-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Engida                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-85-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Ketema                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-86-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Legese                 |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-87-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
                  | firstName                            | Mulu                   |
                  ...
                  | deathCause                           | Non HIV Related        |
            When I POST the FHIR bundle to the IOL
      Scenario: MRN00003A-88-175-062009
            Given I set FHIR bundle parameters
                  | key                                  | value                  |
                  | orgId                                | HIVOrganizationExample |
